...
const EditPediatricPhysicalExam = (props) => {
  ...
  useEffect(() => {
    if (!!event.event_metadata) {
      ...
      setSilvermanAnderson(metadataObj.silvermanAnderson)
      setOxygenSaturation(metadataObj.oxygenSaturation)
      setWeight(metadataObj.weight)
      setSizeLength(metadataObj.sizeLength)
      setHeadCircunference(metadataObj.headCircunference)
      setChestCircumference(metadataObj.chestCircumference)
      setAbdominalPerimeter(metadataObj.abdominalPerimeter)
      setBodySurfaceArea(metadataObj.bodySurfaceArea)
      setBodyMassIndex(metadataObj.bodyMassIndex)
      setAttendsNameSign(metadataObj.attendsNameSign)
  ...
  const submitPediatricPhysicalExam = async () => {
    database.editEvent(
      event.id,
      JSON.stringify({
        doctor: userName,
      ...
      <View style={styles.containerLeft}>
        ...
        <View style={{ alignItems: 'center' }}>
          <Button
            ...
            color={'#F77824'}
            onPress={() => submitPediatricPhysicalExam()} />
        </View>
      </View>
    </ScrollView>
  );
...
export default EditPediatricPhysicalExam;
